...
--  Corrections : encodage, vues portables, triggers complets,
--                FK ordering, opened_at, seed emojis corrects
...
-- ============================================================
-- 6. CONDITIONS MÉDICALES SUPPLÉMENTAIRES
-- ============================================================
...
-- ============================================================
-- 9. INGRÉDIENT ↔ ALLERGÈNES (liaison)
-- ============================================================
...
-- ============================================================
-- 12. PLAT_INGREDIENTS (recette / composition)
-- ============================================================
...
-- ============================================================
-- 13. PLAT_ALLERGENS (vue dénormalisée — déduite des ingrédients)
-- ============================================================
...
-- ============================================================
-- 20. ORDER_ITEMS (lignes de commande)
-- ============================================================
...
-- Trigger métier : mise à jour du total commande après ajout d'un item
...
-- Trigger métier : décrément des stocks après ajout d'un item
...
-- ============================================================
-- 21. CUSTOMIZATION_ITEMS (personnalisations d'ingrédients)
-- ============================================================
...
-- ============================================================
-- 23. PAYMENT_EVENTS (webhooks reçus)
-- ============================================================
...
DELIMITER $$
-- CORRECTION : BEFORE UPDATE (était AFTER UPDATE dans certaines versions — interdit pour SET NEW.*)
...
-- ============================================================
-- 28. RECIPE_ITEMS (fiches techniques cuisine)
-- ============================================================
...
-- ============================================================
-- 29. CONTRAINTES DE CLÉS ÉTRANGÈRES
--     (ajoutées après toutes les tables pour éviter les erreurs
--      d'ordre de création sur les outils d'import comme HeidiSQL)
-- ============================================================
...
-- ============================================================
-- 30. VUES (sans DEFINER — portables sur tous les utilisateurs)
-- ============================================================

-- Vue : plats avec leurs macronutriments
...
-- Vue : commandes actives avec détails table et personnel
...
WHERE co.`status` NOT IN ('CLOTUREE', 'ANNULEE');

-- Vue : stocks en état d'alerte
...
-- ============================================================
-- 31. RESTAURATION DES PARAMÈTRES SYSTÈME
-- ============================================================
